 ...
 * @author tunga
 */
public class TKBSVForm extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TKBSVForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
