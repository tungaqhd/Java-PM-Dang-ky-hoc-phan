...
public class ChiTietDangKyHoc {
    ...
    public ChiTietDangKyHoc(String ma_sv, String ma_lop, String ten_lop, String ten_hp, String thu, int tiet_bat_dau, int tiet_ket_thuc, int ma_phong, String ten_phong, String toa_nha, int co_so, String ho_ten, String sdt) {
        this.ma_sv = ma_sv;
        this.ma_lop = ma_lop;
    ...
    public ChiTietDangKyHoc(String thu, int tiet_bat_dau, int tiet_ket_thuc) {
        this.thu = thu;
        this.tiet_bat_dau = tiet_bat_dau;
        this.tiet_ket_thuc = tiet_ket_thuc;
        loai = 0;
    ...
    public String toString() {
        return "ChiTietDangKyHoc{" + "ma_sv=" + ma_sv + ", ma_lop=" + ma_lop + ", ten_lop=" + ten_lop + ", ten_hp=" + ten_hp + ", thu=" + thu + ", tiet_bat_dau=" + tiet_bat_dau + ", tiet_ket_thuc=" + tiet_ket_thuc + ", ma_phong=" + ma_phong + ", ten_phong=" + ten_phong + ", toa_nha=" + toa_nha + ", co_so=" + co_so + '}';
    }
