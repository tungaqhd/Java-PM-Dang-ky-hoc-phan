 ...
 * @author tunga
 */
public class LichGiangDay extends javax.swing.JDialog {

    /**
     * Creates new form TKB
     */
    AlgoDay al = new AlgoDay();
    LichDB lichDB = new LichDB();
    public LichGiangDay(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    {
        addSubject(panelT2, gv.getMa_gv(), "T2");
        addSubject(panelT3, gv.getMa_gv(), "T3");
        addSubject(panelT4, gv.getMa_gv(), "T4");
        addSubject(panelT5, gv.getMa_gv(), "T5");
        addSubject(panelT6, gv.getMa_gv(), "T6");
        addSubject(panelT7, gv.getMa_gv(), "T7");
        addSubject(panelCN, gv.getMa_gv(), "CN");
    }

    private void addSubject(JPanel panelThu, int msv, String thu) {
        ArrayList<ChiTietDay> tmp = lichDB.getTKB(msv, thu);
        ArrayList<ChiTietDay> dsTiet = al.getList(tmp);
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Lịch Giảng Dạy");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LichGiangDay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LichGiangDay dialog = new LichGiangDay(new javax.swing.JFrame(), true);
